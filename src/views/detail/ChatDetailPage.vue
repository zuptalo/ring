...
.chat-content {
  /* Chat wallpaper (spec 1047): a WhatsApp-style doodle of varied line glyphs
     around Ring's shield, tiled over the theme background. The asset's neutral
     mid-grey strokes read clearly on BOTH themes (one file, no per-theme fork);
     see src/assets/chat-doodle.svg. */
  --background:
    url('@/assets/chat-doodle.svg') repeat,
