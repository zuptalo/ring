...
- [ ] T001 (#870) Add optional `presentation?: 'fullscreen'`, `retired?: true`, `successor?: string` fields to `GameModule` in `src/games/types.ts` (doc comments explaining each; no game changes yet — typecheck stays green)
