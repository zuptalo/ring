...
- [x] T031 Walk `specs/0005-call-waiting-hold/quickstart.md` end-to-end, including the on-device iOS/Safari hold/swap check via `make deploy-dev` (the hard cross-browser constraint, FR-013).
